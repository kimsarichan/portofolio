...
<div class="container">
	...
	<?php
		$footer_sections = 0;
		$zerif_address = get_theme_mod('zerif_address',__('Jakarta','zerif-lite'));
		$zerif_address_icon = get_theme_mod('zerif_address_icon',get_template_directory_uri().'/images/map25-redish.png');
		
		$zerif_email = get_theme_mod('zerif_email','<a href="office@sabasior.com">office@sabasior.com</a>');
		$zerif_email_icon = get_theme_mod('zerif_email_icon',get_template_directory_uri().'/images/envelope4-green.png');
		
		$zerif_phone = get_theme_mod('zerif_phone','<a href="tel:0220989">02298989</a>');
